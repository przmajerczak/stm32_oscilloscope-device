...
void dualChannelMode_writeChannel1ToBuffer(const uint32_t adc_data[], const uint32_t measurements_period)
{
...
void dualChannelMode_writeChannel2ToBuffer(const uint32_t adc_data[], const uint32_t measurements_period)
{
    for (uint16_t sample_idx = 0; sample_idx < SAMPLES_PER_DATA_TRANSFER; sample_idx += 3)
    {
...
void singleChannelMode_writeOnlyChannelToBuffer(const uint32_t adc_data[], const uint32_t measurements_period, const uint16_t channelId)
{
